    ...
    <!-- =====================================================
         OUR APPROACH
    ====================================================== -->
    <section class="section section--white section--center" id="approach" aria-labelledby="approach-heading">
      <div class="container">
        <p class="overline">Our Approach</p>
        <h2 id="approach-heading">Dominate Results Today.<br>Lead the AI Transition Tomorrow.</h2>
        <p class="section__body">The way clients find lawyers is changing faster than most marketing agencies are willing to admit. We combine the traditional SEO fundamentals that drive results today with the AI-ready infrastructure that will determine who gets found tomorrow.</p>
      </div>
    </section>
    ...
    <section class="section section--alt" id="services" aria-labelledby="services-heading">
      <div class="container">
        <div class="services-intro">
          ...
          <h2 id="services-heading">Built for the next generation of search</h2>
          <p class="section__body">Every service we offer is designed around one question: will this help your firm get found, read, and contacted by AI-driven search?</p>
        </div>
    ...
    <!-- =====================================================
         OUR WORK
    ====================================================== -->
    <section class="section section--white" id="work" aria-labelledby="work-heading">
      <div class="container">
        <div class="our-work">
          ...
          <div class="our-work__images">
            <img
              src="<?php echo esc_url( site_url( '/wp-content/uploads/2026/06/susan-curcio-homepage-1-scaled.png' ) ); ?>"
              alt="Susan Curcio Law — website by Pillar Legal Marketing"
              class="our-work__img"
              loading="lazy"
            >
          </div>
      ...
      <div class="container">
        <div class="about-layout">
          <div class="about__image">
            <img
              src="<?php echo esc_url( site_url( '/wp-content/uploads/2026/06/anup-homepage-pic.jpg' ) ); ?>"
              alt="Anup Sheth, Founder of Pillar Legal Marketing"
              loading="lazy"
            >
          </div>
    ...
    <!-- =====================================================
         TESTIMONIAL
    ====================================================== -->
    <section class="section section--white testimonial-section" aria-label="Client testimonial">
      <div class="container">
        <div class="testimonial-layout">
          <div class="testimonial-portrait" role="img" aria-label="Heather Gomes, Esq." style="background-image: url('<?php echo esc_url( site_url( '/wp-content/uploads/2026/06/HLG-21-scaled-1.jpg' ) ); ?>');"></div>
          <blockquote class="testimonial">
            <p class="testimonial__quote">My experience with Pillar Legal Marketing was great! I needed a website that showcased my legal expertise but also conveyed empathy and trust, and Anup was able to design a visually-pleasing, user-friendly website that did just that. Anup is skilled, patient, kind, and easy to work with. I highly recommend his services.</p>
            <cite class="testimonial__cite">Heather Gomes, Esq.</cite>
          </blockquote>
        </div>
      </div>
    </section>
    ...
    <section class="section section--white" id="blog" aria-labelledby="blog-heading">
      <div class="container">
        <div class="blog-intro">
          ...
          <h2 id="blog-heading">Insights For Your Legal Practice</h2>
        </div>
